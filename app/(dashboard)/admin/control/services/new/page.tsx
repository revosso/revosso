...
export default function NewServicePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setErrors({})
    try {
      const res = await authenticatedFetch("/api/admin/control/services", getAccessToken, {
        method: "POST",
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                {errors.cost && <p className="text-red-400 text-xs">{errors.cost[0]}</p>}
              </div>
              <div className="space-y-1.5">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button type="button" variant="ghost" asChild className="text-slate-400">
                <Link href="/admin/control/services">Cancel</Link>
              </Button>
            </div>
          </form>
        </CardContent>
