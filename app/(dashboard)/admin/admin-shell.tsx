...
/**
 * AdminShell — client wrapper for the entire admin layout.
 *
 * By placing AdminProtectedRoute here (around the header, sidebar, AND
 * children), the auth loading spinner replaces the whole page rather than
 * flashing the chrome (header + sidebar) before the auth check completes.
 */
